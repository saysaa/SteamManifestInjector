...
namespace WinFormsApp1
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void GitHub_link_button_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start("cmd.exe", $"/c start https://github.com/saysaa/SteamManifestInjector");
        }
    }
}
